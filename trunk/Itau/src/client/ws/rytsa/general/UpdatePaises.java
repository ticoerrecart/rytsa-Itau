 ...
 *         &lt;element name="beOriginal" type="{http://tempuri.org/}BEPaises" minOccurs="0"/>
...
@XmlRootElement(name = "UpdatePaises")
public class UpdatePaises {

    @XmlElement(required = true)
    protected String idSesion;
    protected BEPaises beOriginal;
     ...
     *     
     */
    public void setBeOriginal(BEPaises value) {
