 ...
 *         &lt;element name="request" type="{http://api.patron.mae.com.ar/sistemasexternos/itau}ArrayOfNovedadesValuacionesRequestData" minOccurs="0"/>
...
@XmlRootElement(name = "InformarNovedadesValuaciones")
public class InformarNovedadesValuaciones {

    @XmlElement(required = true)
    protected String idSesion;
    protected ArrayOfNovedadesValuacionesRequestData request;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link ArrayOfNovedadesValuacionesRequestData }
     *     
     */
    public ArrayOfNovedadesValuacionesRequestData getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(ArrayOfNovedadesValuacionesRequestData value) {
        this.request = value;
    }
