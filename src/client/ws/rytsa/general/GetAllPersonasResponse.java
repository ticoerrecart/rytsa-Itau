 ...
 *       &lt;sequence>
 *         &lt;element name="GetAllPersonasResult" type="{http://tempuri.org/}BEEstado" minOccurs="0"/>
...
@XmlType(name = "", propOrder = {
    "getAllPersonasResult",
    "totalrecord",
    "beArray"
})
@XmlRootElement(name = "GetAllPersonasResponse")
public class GetAllPersonasResponse {

    @XmlElement(name = "GetAllPersonasResult")
    protected BEEstado getAllPersonasResult;
    protected long totalrecord;
    protected ArrayOfBEPersonas beArray;

    /**
     * Gets the value of the getAllPersonasResult property.
     * 
     * @return
     *     possible object is
     *     {@link BEEstado }
     *     
     */
    public BEEstado getGetAllPersonasResult() {
        return getAllPersonasResult;
    }

    /**
     * Sets the value of the getAllPersonasResult property.
     * 
     * @param value
     *     allowed object is
     *     {@link BEEstado }
     *     
     */
    public void setGetAllPersonasResult(BEEstado value) {
        this.getAllPersonasResult = value;
    }
